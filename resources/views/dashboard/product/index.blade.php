...
<body>
                ...
                <div class="row align-items-center">
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              <li class="breadcrumb-item"><a href="{{route('indexProduct')}}" class="link"><i class="mdi mdi-home-outline fs-4"></i></a></li>
                    ...
                    <div class="col-6">
                        <div class="text-end upgrade-btn">
                            <button class="btn btn-primary text-white" onClick="create()">Tambah Produk</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive" id="listProduct">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function read() {
            $.get("{{ route('readProduct') }}", {}, function(data, status) {
                $("#listProduct").html(data);
            });
        }

        function create() {
            $.get("{{ route('createProduct') }}", {}, function(data, status) {
                $("#title").html('Create Produk')
                $("#formInput").html(data);
